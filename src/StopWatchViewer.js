(function (window, factory) {
    ...
    function StopWatchViewer(parameters) {
        ...
        for (var key in this.parameters) {
            ...
            this.parameters[key] = !!parameters[key] ? parameters[key] : this.parameters[key];
        }
        this._initSymfonyToolbar();
    }

    StopWatchViewer.prototype._initSymfonyToolbar = function () {
        ...
        var internalStopWatch = this.parameters.stopWatchExporter.getStopWatch();
    ...
    StopWatchViewer.prototype._render = function () {
        this.container.innerHTML = '<div style="overflow-x:auto;"></div>';
        this.renderData = this.parameters.stopWatchExporter.getExportData();
    ...
    StopWatchViewer.prototype._fixTextPosition = function () {
    ...
    StopWatchViewer.prototype._renderRequest = function (ratio, request) {
    ...
    StopWatchViewer.prototype._drawBackground = function (svg, events) {
    ...
    StopWatchViewer.prototype._renderEvent = function (svg, line, event) {
        ...
        tspan.innerHTML = event.name + ' ' + event.duration.toString() + ' ns.';
        text.appendChild(tspan);
        svg.appendChild(text);
